...
function App() {
  ...
  const fetchStats = async () => {
    try {
      ...
      // const response = await fetch('https://laisa1-pothole-patrol-backend.hf.space/api/reports?page=1&limit=1');
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // const response = await fetch('https://laisa1-pothole-patrol-backend.hf.space/api/detect', {
